...
extern int g_CryptoTaHandle_Read(uint32_t paramTypes, TEE_Param params[4]);
extern int g_CryptoTaHandle_Write(uint32_t paramTypes, TEE_Param params[4]);
extern int g_CryptoTaHandle_Dump(uint32_t paramTypes, TEE_Param params[4]);
